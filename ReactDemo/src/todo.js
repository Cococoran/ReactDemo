  ...
  render() {
    ...
    return (
      <div className="todo-div">
        <h2 className='todoTitle'>TodoList</h2>
        <div>
          <input className="TodoInput" onChange={this.handleChange} value={this.state.text} placeholder="输入事项" />
          <button className="TodoButton" onClick={this.handleSubmit}>{buttonTitle}</button>
        </div>
